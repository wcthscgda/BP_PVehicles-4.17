...
#include "BP_Test__pf2481680385.generated.h"
UCLASS(config=Game, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Vehicles/Test/BP_Test.BP_Test_C", OverrideNativeName="BP_Test_C"))
class ABP_Test_C__pf2481680385 : public APawn
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="Wheels", Category="Default", OverrideNativeName="Wheels"))
	TArray<FWheel_Structure__pf863842189> bpv__Wheels__pf;
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="Suspension Length", Category="Default", OverrideNativeName="Suspension Length"))
	...
	FWheel_Structure__pf863842189 b0l__CallFunc_Array_Get_Item__pf;
	...
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="CallFunc_SphereTraceMulti_OutHits"))
	TArray<FHitResult> b0l__CallFunc_SphereTraceMulti_OutHits__pf;
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="CallFunc_Array_Get_Item2"))
	FHitResult b0l__CallFunc_Array_Get_Item2__pf;
	...
	ABP_Test_C__pf2481680385(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_BP_Test__pf_0(int32 bpp__EntryPoint__pf);
